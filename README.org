...
The default host, built using QEMU[fn:22], a free and open-source emulator that can perform hardware virtualization. It features a lightweight system optimized for development, running GNU/Emacs[fn:2] + EXWM[fn:23] as the graphical environment.
...
The file system for this host is a single 24GB QCOW file, a format for disk images used by QEMU[fn:22]. The file can be recreated easily by following the steps listed in the NixOS[fn:4] installation manual, specifically the section on disk formatting.
...
My gaming laptop, the model is an Acer Nitro AN-515-53[fn:24]. The Nitro 5 has more in common with the mid-range notebooks rather than the gaming models due to its cooling design, chassis, and overall construction.
...
The Raspberry Pi 400[fn:25] is your complete personal computer, built into a compact keyboard. It features a quad-core, 64-bit processor, 4GB of RAM, wireless networking, dual-display output, 4k video playback, as well as a 40-pin GPIO header. It's the most powerful Raspberry Pi computer yet.
...
X11, or X[fn:28] is the generic name for the X Window System Display Server. All graphical GNU/Linux[fn:1] applications connect to an X-Window[fn:28] (or Wayland[fn:29]) to display graphical data on the monitor of a computer. Its a program that acts as the interface between graphical applications and the graphics subsystem of the computer.
...
OpenSSH[fn:30] is a suite of secure networking utilities based on the Secure Shell Protocol, which provides a secure channel over an unsecured network in a client-server architecture. OpenSSH[fn:30] started as a fork of the free SSH program; later versions were proprietary software.
...
Hugo[fn:31] is one of the most popular open-source static site generators.
...
Cachix[fn:33] is a Command line client for Nix[fn:5] binary cache hosting. This allows downloading and usage of pre-compiled binaries for applications on /nearly/ every available system architecture. This speeds up the time it takes to rebuild configurations.
...
Use the ~lspci~ command to determine the type of graphics card you have, following the guide on NVIDIA at the NixOS Wiki[fn:34].
...
Firefox Browser[fn:35], also known as Mozilla Firefox or simply Firefox, is a free and open-source web browser developed by the Mozilla Foundation and its subsidiary, the Mozilla Corporation. Firefox uses the Gecko layout engine to render web pages, which implements current and anticipated web standards. In 2017, Firefox began incorporating new technology under the code name Quantum to promote parallelism and a more intuitive user interface.
...
The Teamviewer[fn:38] remote connectivity cloud platform enables secure remote access to any device, across platforms, from anywhere, anytime. Teamviewer[fn:38] connects computers, smartphones, servers, IoT devices, robots -- anything -- with fast, high performance connections through their global access network. It has been used in outer-space low-bandwidth environments.
...
GTK[fn:42] is a free and open-source, cross-platform widget toolkit for graphical user interfaces. It's one of the most popular toolkits for the Wayland[fn:29] and X11[fn:28] windowing systems.
...
Nix-mode[fn:43] is an Emacs[fn:2] major mode for editing Nix[fn:5] expressions. This provides basic handling of =.nix= files. Syntax highlighting and indentation support using =SMIE= are provided.
...
EXWM (Emacs X Window Manager)[fn:23] is a full-featured tiling X window manager for GNU/Emacs[fn:2] built on-top of XELB. It features:
...
I wanted to leave ~(exwm-enable)~ out of my Emacs configuration (which does no harm anyways). This can be called when using the daemon to start EXWM[fn:23].
...
EXWM[fn:23] cannot make an X window manager by itself, this is by design; You must tell X to do it. Override the =~/.xinitrc= file to start the =xsession=.
...
Org Drill[fn:62] is an extension for Org Mode[fn:58] that uses a spaced repition algorithm to conduct interactive /Drill Sessions/ using Org files as sources of facts to be memorized.
...
Writegood Mode[fn:65] is an Emacs[fn:2] minor mode to aid in finding common writing problems. It highlights the text based on the following criteria:
...
GNU Aspell[fn:66] is a Free and Open Source spell checker designed to replace ISpell. It can be used as a library, or an independent spell checker. Its main feature is that it does a superior job of suggesting possible replacements for mis-spelled words than any other spell checker for the English language.
...
Ox-Hugo[fn:67] is an Org-Mode[fn:58] exporter for Hugo[fn:31] compabile markdown. I post nonsense on my Personal Blog[fn:68], and share my notes on various textbooks, articles, and software Here[fn:69].
...
Reveal.js[fn:70] is an open source HTML presentation framework. It enables anyone with a web browser to create fully-featured and beautiful presentations for free. Presentations with Reveal.js[fn:70] are built on open web technologies. That means anything you can do on the web, you can do in your presentation. Ox Reveal[fn:71] is an Org Mode[fn:58] export backend.
...
Go Mode[fn:77] is a major mode for editing Golang[fn:12] source code in GNU/Emacs[fn:2].
...
Rustic[fn:76] is a fork of rust-mode that integrates well with the Language Server Protocol[fn:72]. Include the rust shell before launching GNU/Emacs[fn:2] to use this!
...
The built in Python Mode[fn:78] has a nice feature set for working with Python[fn:18] code in GNU/Emacs[fn:2]. It is complimented with the addition of an LSP[fn:74] server. These tools are included in the Development Shell[fn:11] for Python[fn:18].
...
The Desktop Environment[fn:82] package provides commands and a global minor mode for controlling your GNU/Linux[fn:1] desktop from within GNU/Emacs[fn:2].
...
Doom Modeline[fn:24] is a fancy and fast modeline inspired by minimalism design. It's integrated into Centaur Emacs, Doom Emacs, and Spacemacs.
...
[fn:22] https://qemu.org

[fn:23] https://github.com/ch11ng/exwm

[fn:24] https://laptopmedia.com/laptop-specs/acer-nitro-5-an515-53-2

[fn:25] https://raspberrypi.org/products/raspberry-pi-400/

[fn:26] https://www.raspberrypi.org/products/raspberry-pi-4-model-b/

[fn:27] https://samsung.com/us/mobile/galaxy-s10/buy/

[fn:28] https://x.org/wiki/

[fn:29] https://wayland.freedesktop.org

[fn:30] https://openssh.com

[fn:31] https://gohugo.io

[fn:32] https://nixos.wiki/wiki/Flakes

[fn:33] https://nix-community.cachix.org

[fn:34] https://nixos.wiki/wiki/Nvidia

[fn:35] https://en.wikipedia.org/wiki/Firefox

[fn:36] https://jellyfin.org

[fn:37] https://moonlight-stream.org

[fn:38] https://teamviewer.com
...
[fn:61] https://github.com/org-roam/org-roam-server

[fn:62] https://orgmode.org/worg/org-contrib/org-drill.html

[fn:63] https://github.com/marcinkoziej/org-pomodoro

[fn:64] https://en.wikipedia.org/wiki/Pomodoro_Technique

[fn:65] https://github.com/bnbeckwith/writegood-mode

[fn:66] https://aspell.net

[fn:67] https://oxhugo.scripter.co

[fn:68] https://chrishayward.xyz/posts/

[fn:69] https://chrishayward.xyz/notes/

[fn:70] https://revealjs.com

[fn:71] https://github.com/hexmode/ox-reveal

[fn:72] https://password-store.org
...
[fn:84] https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html
