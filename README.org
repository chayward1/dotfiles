...
Dired[fn:42] shows a directory listing inside of an Emacs[fn:2] buffer that can be used to perform various file operations on files and subdirectories. THe operations you can perform are numerous, from creating subdirectories, byte-compiling files, searching, and editing files. Dired-Extra[fn:43] provides extra functionality for Dired[fn:42].
...
All The Icons[fn:44] is a utility package to collect various Icon Fonts and prioritize them within GNU/Emacs[fn:2].
...
Emojify[fn:45] is an Emacs[fn:2] extension to display Emojis. It can display GitHub style Emojis like :smile: or plain ascii ones such as :). It tries to be as efficient as possible, while also providing flexibility.
...
EShell [fn:46] is a shell-like command interpreter for GNU/Emacs[fn:2] implemented in Emacs Lisp[fn:35]. It invokes no external processes except for those requested by the user. It's intended to be an alternative for IELM, and a full REPL envionment for Emacs[fn:2].
...
Emacs Libvterm (VTerm)[fn:47] is a fully-fledged terminal emulator inside GNU/Emacs[fn:2] based on Libvterm[fn:48], a blazing fast C library used in Neovim[fn:36]. As a result of using compiled code (instead of Emacs Lisp[fn:35]), VTerm[fn:47] is capable, fast, and it can seamlessly handle large outputs.
...
Elfeed[fn:50] is an extensible web feed reader for GNU/Emacs[fn:2], support both =Atom= and =RSS=. It requires =Emacs 24.3+= and is available for download from the standard repositories.
...
Org-mode[fn:51] is a document editing and organizing mode, designed for notes, planning, and authoring within the free software text editor GNU/Emacs[fn:2]. The name is used to encompass plain text files (such as this one) that include simple marks to indicate levels of a hierarchy, and an editor with functions that can read the markup and manipulate the hierarchy elements.
...
Org Drill[fn:55] is an extension for Org Mode[fn:51] that uses a spaced repition algorithm to conduct interactive /Drill Sessions/ using Org files as sources of facts to be memorized.
...
The way Org Mode[fn:51] works, TODO items, time-stamped items, and tagged headlines can be scattered throughout a file, or even a number of files. To get an overview of open action items, or of events that are important for a particular date, this information must be collected, sorted, and displayed in an organized way.
...
Writegood Mode[fn:58] is an Emacs[fn:2] minor mode to aid in finding common writing problems. It highlights the text based on the following criteria:
...
GNU Aspell[fn:59] is a Free and Open Source spell checker designed to replace ISpell. It can be used as a library, or an independent spell checker. Its main feature is that it does a superior job of suggesting possible replacements for mis-spelled words than any other spell checker for the English language.
...
Hugo[fn:60] is one of the most popular open-source static site generators.
...
Ox-Hugo[fn:61] is an Org-Mode[fn:51] exporter for Hugo[fn:60] compabile markdown. I post nonsense on my Personal Blog[fn:62], and share my notes on various textbooks, articles, and software Here[fn:63].
...
Projectile[fn:67] is a project interaction library for GNU/Emacs[fn:2]. Its goal is to provide a nice set of features operating on a project level, without introducing external dependencies.
...
The Language Server Protocol (LSP)[fn:68] defines the protocol used between an Editor or IDE, and a language server that provides features like:
...
Company[fn:69] is a text completion framework for GNU/Emacs[fn:2]. The name stands for =Complete Anything=. It uses pluggable back-ends and front-ends to retieve and display completion candidates.
...
PlantUML[fn:72] is an open-source tool allowing users to create diagrams from a plain-text language. Besides various UML diagrams, PlantUML[fn:72] has support for various other software developmented related formats, as well as visualizations of =JSON= and =YAML= files.
...
PlantUML Mode[fn:73] is a major mode for editing PlantUML[fn:72] sources in GNU/Emacs[fn:2].
...
Ivy (Swiper)[fn:74] is a generic completion mechanism for GNU/Emacs[fn:2]. While operating similarily to other completion schemes like =icomplete-mode=, it aims to be more efficient, smaller, simpler, and smoother to use, while remaining highly customizable.
...
The Desktop Environment[fn:75] package provides commands and a global minor mode for controlling your GNU/Linux[fn:1] desktop from within GNU/Emacs[fn:2].
...
Doom Themes[fn:76] is a theme megapack for GNU/Emacs[fn:2], inspired by community favourites.
...
Doom Modeline[fn:77] is a fancy and fast modeline inspired by minimalism design. It's integrated into Centaur Emacs, Doom Emacs, and Spacemacs.
...
[fn:42] https://emacswiki.org/emacs/DiredMode

[fn:43] https://emacswiki.org/emacs/DiredExtra#Dired_X

[fn:44] https://github.com/domtronn/all-the-icons.el

[fn:45] https://github.com/iqbalansari/emacs-emojify

[fn:46] https://gnu.org/software/emacs/manual/html_mono/eshell.html

[fn:47] https://github.com/akermu/emacs-libvterm

[fn:48] https://github.com/neovim/libvterm

[fn:49] https://magit.vc

[fn:50] https://github.com/skeeto/elfeed

[fn:51] https://orgmode.org

[fn:52] https://github.com/org-roam/org-roam

[fn:53] https://zettelkasten.de

[fn:54] https://github.com/org-roam/org-roam-server

[fn:55] https://orgmode.org/worg/org-contrib/org-drill.html

[fn:56] https://marcinkoziej/org-pomodoro

[fn:57] https://en.wikipedia.org/wiki/Pomodoro_Technique

[fn:58] https://github.com/bnbeckwith/writegood-mode

[fn:59] https://aspell.net

[fn:60] https://gohugo.io

[fn:61] https://oxhugo.scripter.co

[fn:62] https://chrishayward.xyz/posts/

[fn:63] https://chrishayward.xyz/notes/

[fn:64] https://revealjs.com

[fn:65] https://github.com/hexmode/ox-reveal

[fn:66] https://password-store.org

[fn:67] https://projectile.mx

[fn:68] https://microsoft.github.io/language-server-protocol

[fn:69] https://company-mode.github.io

[fn:70] https://emacswiki.org/emacs/GoMode
