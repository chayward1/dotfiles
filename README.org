...
gRPC[fn:19] is a modern open-source, high-performance Remote Procedure Call (RPC) framework that can run in any environment. It can efficiently connect services in and across data centres with pluggable support for load balancing, tracing, health checking, and authentication.
...
Python[fn:22] is an interpreted high-level, general-purpose programming language. Its design philosophy emphasizes code readability, with its notable use of significant indentation. Its language constructs, as well as its object-oriented approach aim to help programmers write clear, logical, code for small and large projects.
...
X11, or X[fn:23] is the generic name for the X Window System Display Server. All graphical GNU/Linux[fn:1] applications connect to an X-Window[fn:23] (or Wayland[fn:24]) to display graphical data on the monitor of a computer. Its a program that acts as the interface between graphical applications and the graphics subsystem of the computer.
...
Cachix[fn:26] is a Command line client for Nix[fn:5] binary cache hosting. This allows downloading and usage of pre-compiled binaries for applications on /nearly/ every available system architecture. This speeds up the time it takes to rebuild configurations.
...
Docker [fn:27] is a set of platform as a service that uses OS level virtualization to deliver software in packages called containers. Containers are isolated from one another and bundle their own software, libraries, and configuration files; they can communicate with each other through well-defined channels.
...
Firefox Browser[fn:28], also known as Mozilla Firefox or simply Firefox, is a free and open-source web browser developed by the Mozilla Foundation and its subsidiary, the Mozilla Corporation. Firefox uses the Gecko layout engine to render web pages, which implements current and anticipated web standards. In 2017, Firefox began incorporating new technology under the code name Quantum to promote parallelism and a more intuitive user interface.
...
Moonlight[fn:30] is an open-source implementation of NVIDIA's GameStream Protocol. You can stream your collection of PC games from your GameStream-compatible PC to any supported device and play them remotely. Moonlight[fn:30] is perfect for gaming on the go (or on GNU/Linux[fn:1]) without sacrificing the graphics and game selection available for the PC.
...
GNU Privacy Guard[fn:33] is a free-software replacement for Symantec's PGP cryptographic software suite. It is compliant with RFC 4880, the IETF standards-track specification of OpenPGP. Modern versions of PGP are interoperable with GnuPG and other OpenPGP-compliant systems.
...
Neovim[fn:34] is a project that seeks to aggressively refactor Vim in order to:
...
GTK[fn:35] is a free and open-source, cross-platform widget toolkit for graphical user interfaces. It's one of the most popular toolkits for the Wayland[fn:24] and X11[fn:23] windowing systems.
...
GNU/Emacs[fn:2] is an extensible, customizable, free/libre text editor -- and more. At its core is an interpreter for Emacs Lisp[fn:33], a dialect of the Lisp programming language with extensions to support text editing. Other features include:
...
Nix-mode[fn:36] is an Emacs[fn:2] major mode for editing Nix[fn:5] expressions. This provides basic handling of =.nix= files. Syntax highlighting and indentation support using =SMIE= are provided.
...
Evil[fn:13] is an extensible VI layer for GNU/Emacs[fn:2]. It emulates the main features of Vim[fn:34], turning GNU/Emacs[fn:2] into a modal editor.
...
The next time Emacs[fn:2] is started, it will come up in /normal state/, denoted by =<N>= in the modeline. This is where the main ~vi~ bindings are defined. Like Emacs[fn:2] in general, Evil[fn:13] is extensible in Emacs Lisp[fn:33].
...
General[fn:37] provides a more convenient method for binding keys in Emacs[fn:2], providing a unified interface for key definitions. Its primary purpose is to build on /existing/ functionality to make key definitions more clear and concise.
...
Which-key[fn:38] is a minor mode for Emacs[fn:2] that displays the key bindings following your currently entered incomplete command (prefix) in a popup or mini-buffer.
...
The Emacs Web Wowser[fn:39] is a Web browser written in Emacs Lisp[fn:33] based on the ~shr.el~ library. It's my primary browser when it comes to text-based browsing.
...
Dired[fn:40] shows a directory listing inside of an Emacs[fn:2] buffer that can be used to perform various file operations on files and subdirectories. THe operations you can perform are numerous, from creating subdirectories, byte-compiling files, searching, and editing files. Dired-Extra[fn:41] provides extra functionality for Dired[fn:40].
...
All The Icons[fn:42] is a utility package to collect various Icon Fonts and prioritize them within GNU/Emacs[fn:2].
...
Emojify[fn:43] is an Emacs[fn:2] extension to display Emojis. It can display GitHub style Emojis like :smile: or plain ascii ones such as :). It tries to be as efficient as possible, while also providing flexibility.
...
EShell [fn:44] is a shell-like command interpreter for GNU/Emacs[fn:2] implemented in Emacs Lisp[fn:33]. It invokes no external processes except for those requested by the user. It's intended to be an alternative for IELM, and a full REPL envionment for Emacs[fn:2].
...
Emacs Libvterm (VTerm)[fn:45] is a fully-fledged terminal emulator inside GNU/Emacs[fn:2] based on Libvterm[fn:46], a blazing fast C library used in Neovim[fn:34]. As a result of using compiled code (instead of Emacs Lisp[fn:33]), VTerm[fn:45] is capable, fast, and it can seamlessly handle large outputs.
...
Elfeed[fn:48] is an extensible web feed reader for GNU/Emacs[fn:2], support both =Atom= and =RSS=. It requires =Emacs 24.3+= and is available for download from the standard repositories.
...
Org-mode[fn:49] is a document editing and organizing mode, designed for notes, planning, and authoring within the free software text editor GNU/Emacs[fn:2]. The name is used to encompass plain text files (such as this one) that include simple marks to indicate levels of a hierarchy, and an editor with functions that can read the markup and manipulate the hierarchy elements.
...
Org Drill[fn:53] is an extension for Org Mode[fn:49] that uses a spaced repition algorithm to conduct interactive /Drill Sessions/ using Org files as sources of facts to be memorized.
...
Writegood Mode[fn:56] is an Emacs[fn:2] minor mode to aid in finding common writing problems. It highlights the text based on the following criteria:
...
GNU Aspell[fn:57] is a Free and Open Source spell checker designed to replace ISpell. It can be used as a library, or an independent spell checker. Its main feature is that it does a superior job of suggesting possible replacements for mis-spelled words than any other spell checker for the English language.
...
Hugo[fn:58] is one of the most popular open-source static site generators.
...
Ox-Hugo[fn:59] is an Org-Mode[fn:49] exporter for Hugo[fn:58] compabile markdown. I post nonsense on my Personal Blog[fn:60], and share my notes on various textbooks, articles, and software Here[fn:61].
...
Projectile[fn:65] is a project interaction library for GNU/Emacs[fn:2]. Its goal is to provide a nice set of features operating on a project level, without introducing external dependencies.
...
The Language Server Protocol (LSP)[fn:66] defines the protocol used between an Editor or IDE, and a language server that provides features like:
...
Company[fn:67] is a text completion framework for GNU/Emacs[fn:2]. The name stands for =Complete Anything=. It uses pluggable back-ends and front-ends to retieve and display completion candidates.
...
Go Mode[fn:68] is a major mode for editing Golang[fn:18] source code in GNU/Emacs[fn:2].
...
[fn:20] https://iso.org/standard/74528.html

[fn:21] https://en.wikipedia.org/wiki/C++

[fn:22] https://python.org

[fn:23] https://x.org/wiki/

[fn:24] https://wayland.freedesktop.org

[fn:25] https://nixos.wiki/wiki/Flakes

[fn:26] https://nix-community.cachix.org

[fn:27] https://docker.org

[fn:28] https://en.wikipedia.org/wiki/Firefox

[fn:29] https://jellyfin.org

[fn:30] https://moonlight-stream.org

[fn:31] https://teamviewer.com

[fn:32] https://git-scm.com

[fn:33] https://emacswiki.org/emacs/LearnEmacsLisp

[fn:34] https://neovim.io

[fn:35] https://gtk.org

[fn:36] https://github.com/nixos/nix-mode

[fn:37] https://github.com/noctuid/general.el

[fn:38] https://github.com/justbur/emacs-which-key

[fn:39] https://emacswiki.org/emacs/eww

[fn:40] https://emacswiki.org/emacs/DiredMode

[fn:41] https://emacswiki.org/emacs/DiredExtra#Dired_X

[fn:42] https://github.com/domtronn/all-the-icons.el

[fn:43] https://github.com/iqbalansari/emacs-emojify

[fn:44] https://gnu.org/software/emacs/manual/html_mono/eshell.html

[fn:45] https://github.com/akermu/emacs-libvterm

[fn:46] https://github.com/neovim/libvterm

[fn:47] https://magit.vc

[fn:48] https://github.com/skeeto/elfeed

[fn:49] https://orgmode.org

[fn:50] https://github.com/org-roam/org-roam

[fn:51] https://zettelkasten.de

[fn:52] https://github.com/org-roam/org-roam-server

[fn:53] https://orgmode.org/worg/org-contrib/org-drill.html

[fn:54] https://marcinkoziej/org-pomodoro

[fn:55] https://en.wikipedia.org/wiki/Pomodoro_Technique

[fn:56] https://github.com/bnbeckwith/writegood-mode

[fn:57] https://aspell.net

[fn:58] https://gohugo.io

[fn:59] https://oxhugo.scripter.co

[fn:60] https://chrishayward.xyz/posts/

[fn:61] https://chrishayward.xyz/notes/

[fn:62] https://revealjs.com

[fn:63] https://github.com/hexmode/ox-reveal

[fn:64] https://password-store.org

[fn:65] https://projectile.mx

[fn:66] https://microsoft.github.io/language-server-protocol

[fn:67] https://company-mode.github.io

[fn:68] https://emacswiki.org/emacs/GoMode

[fn:69] https://github.com/brotzeit/rustic

[fn:70] https://emacswiki.org/emacs/PythonProgrammingInEmacs

[fn:71] https://plantuml.com

[fn:72] https://github.com/skuro/plantuml-mode

[fn:73] https://github.com/abo-abo/swiper

[fn:74] https://github.com/DamienCassou/desktop-environment

[fn:75] https://github.com/hlissner/emacs-doom-themes

[fn:76] https://github.com/seagle0128/doom-modeline

[fn:77] https://laptopmedia.com/laptop-specs/acer-nitro-5-an515-53-2
