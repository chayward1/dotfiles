...
Go[fn:1] is an open-source programming language that makes it easy to build simple, reliable, and efficient software. It's statically typed and compiled programming language. It's syntactically similar to C, but with memory safety, garbage collection, structural typing, and CSP-style concurrency.
...
Rust[fn:2] is a multi-paradigm programming language designed for performance and safety, especially safe concurrency. It is syntactically similar to C++, but can garantee memory safety by using a borrow checker to validate references. Rust[fn:2] achieves memory safety /without/ garbage collection, and reference counting is optional.
...
Node.js[fn:3] is an open-source, cross-platform, back-end JavaScript runtime environment that runs on the V8 engine, and executes JavaScript code outside of a web browser. Node.js[fn:3] lets developers user JavaScript to write command line tools, and for server-side scripting to produce dynamic web page content.
...
OpenJDK[fn:4] is a free and open-source implementation of the Java Platform, Standard Edition. It is the result of an effort Sun Microsystems began in 2006. The implementation is licensed under the GNU General Public License Version 2 with a linking exception.
...
gRPC[fn:5] is a modern open-source, high-performance Remote Procedure Call (RPC) framework that can run in any environment. It can efficiently connect services in and across data centres with pluggable support for load balancing, tracing, health checking, and authentication.
...
C[fn:6] is a general-purpose, procedural computer programming language support structured programming, lexical variable scope, and recursion. It has a static type system, and by design provides constructs that map efficiently to typical machine instructions. C++[fn:7] is a general-purpose programming language created as an extension of the C[fn:6] programming language.
...
Python[fn:8] is an interpreted high-level, general-purpose programming language. Its design philosophy emphasizes code readability, with its notable use of significant indentation. Its language constructs, as well as its object-oriented approach aim to help programmers write clear, logical, code for small and large projects.
...
Compose[fn:9] is a tool for defining and running multi-container Docker[fn:10] applications. With Compose[fn:9], you use a YAML file to configure your application services. Then, with a single command, you create and start all of the services from your configuration.

Machine[fn:11] is a tool that lets you install Docker Engine on virtual hosts, and manage the hosts with ~docker-machine~ commands. You can use Machine[fn:11] to create hosts on your local box, company network, data center, or on any cloud provider.
...
Heroku[fn:12] is a cloud platform as a service supporting several programming languages. One of the first cloud platforms, Heroku[fn:12] has been in development since June 2007, when it supported only the Ruby programming language. It now supports Java, Node.js, Scala, Clojure, Python, PHP, and Go.
...
NixOS[fn:13] typically stores the current machine configuration in =/etc/nixos/configuration.nix=. In this project, this file is stored in =/etc/dotfiles/hosts/$HOSTNAME/...=, and imported, along with the generated hardware configurations. This ensures that multiple host machines can share the same modules, and generating new host definitions is trivial. It also makes it easier to share common configurations amongst all of the hosts, such as with pre-configured wireless networking:
...
The default host, built using QEMU[fn:14], a free and open-source emulator that can perform hardware virtualization. It features a lightweight system optimized for development, running GNU/Emacs[fn:15] + EXWM[fn:16] as the graphical environment.
...
This is a basic default configuration that specified the indended default configuration of the system. Because NixOS[fn:13] has a declarative configuration model, you can create or edit a description of the desired configuration, and update it from one file.
...
The file system for this host is a single 24GB QCOW file, a format for disk images used by QEMU[fn:14]. The file can be recreated easily by following the steps listed in the NixOS[fn:13] installation manual, specifically the section on disk formatting.
...
My gaming laptop, the model is an Acer Nitro AN-515-53[fn:17]. The Nitro 5 has more in common with the mid-range notebooks rather than the gaming models due to its cooling design, chassis, and overall construction.
...
The Raspberry Pi 400[fn:18] is your complete personal computer, built into a compact keyboard. It features a quad-core, 64-bit processor, 4GB of RAM, wireless networking, dual-display output, 4k video playback, as well as a 40-pin GPIO header. It's the most powerful Raspberry Pi computer yet.
...
The Raspberry Pi Model B-8GB[fn:19] is the latest product in the popular Raspberry Pi range of computers. It offers groundbreaking increases in processor speed, multimedia performance, memory, and connectivity compared to the prior generation. On NixOS[fn:13], the Raspberry Pi family is /only/ supported on the =AArch64= platform, although there is community support for =armv6l= and =armv7l=.
...
This is my Samsung Galaxy S10+[fn:20] running Nix On Droid[fn:21] with the experimental support for Flakes being used to manage the configuration.
...
Modules are files combined by NixOS[fn:13] to produce the full system configuration. Modules wre introduced to allow extending NixOS[fn:13] without modifying its source code. They also allow splitting up =configuration.nix=, making the system configuration easier to maintain and use.
...
X11, or X[fn:22] is the generic name for the X Window System Display Server. All graphical GNU/Linux[fn:23] applications connect to an X-Window[fn:22] (or Wayland[fn:24]) to display graphical data on the monitor of a computer. Its a program that acts as the interface between graphical applications and the graphics subsystem of the computer.
...
OpenSSH[fn:25] is a suite of secure networking utilities based on the Secure Shell Protocol, which provides a secure channel over an unsecured network in a client-server architecture. OpenSSH[fn:25] started as a fork of the free SSH program; later versions were proprietary software.
...
Hugo[fn:26] is one of the most popular open-source static site generators.
...
Cachix[fn:29] is a Command line client for Nix[fn:28] binary cache hosting. This allows downloading and usage of pre-compiled binaries for applications on /nearly/ every available system architecture. This speeds up the time it takes to rebuild configurations.
...
Use the ~lspci~ command to determine the type of graphics card you have, following the guide on NVIDIA at the NixOS Wiki[fn:30].
...
Home Manager[fn:35] includes a =flake.nix= file for compatibility with Nix Flakes, a feature utilized heavily in this project. When using flakes, switching to a new configuration is done /only/ for the entire system, using the command ~nixos-rebuild switch --flake <path>~, instead of ~nixos-rebuild~, and ~home-manager~ seperately.
...
GNU Privacy Guard[fn:37] is a free-software replacement for Symantec's PGP cryptographic software suite. It is compliant with RFC 4880, the IETF standards-track specification of OpenPGP. Modern versions of PGP are interoperable with GnuPG and other OpenPGP-compliant systems.
...
Neovim[fn:38] is a project that seeks to aggressively refactor Vim in order to:
...
GTK[fn:39] is a free and open-source, cross-platform widget toolkit for graphical user interfaces. It's one of the most popular toolkits for the Wayland[fn:24] and X11[fn:22] windowing systems.
...
GNU/Emacs[fn:15] is an extensible, customizable, free/libre text editor -- and more. At its core is an interpreter for Emacs Lisp[fn:37], a dialect of the Lisp programming language with extensions to support text editing. Other features include:
...
Emacs[fn:15] has been around since the 1980s, and it's painfully obvious when you're greeted with the default user interface. Disable some unwanted features to clean it up, and bring the appearance to something closer to a modern editor.
...
Emacs[fn:15] makes a backup for a file only the first time the file is saved from a buffer. No matter how many times the file is subsequently written to, the backup remains unchanged. For files managed by a version control system, backup files are redundant since the previous versions are already stored.
...
Define some methods for interaction between GNU/Emacs[fn:15], and the systems underyling shell:

1) Method to run an external process, launching any application on a new process without interferring with Emacs[fn:15]
2) Method to apply commands to the curren call process, effecting the running instance of Emacs[fn:15]
...
Nix-mode[fn:40] is an Emacs[fn:15] major mode for editing Nix[fn:28] expressions. This provides basic handling of =.nix= files. Syntax highlighting and indentation support using =SMIE= are provided.
...
Evil[fn:41] is an extensible VI layer for GNU/Emacs[fn:15]. It emulates the main features of Vim[fn:38], turning GNU/Emacs[fn:15] into a modal editor.
...
The next time Emacs[fn:15] is started, it will come up in /normal state/, denoted by =<N>= in the modeline. This is where the main ~vi~ bindings are defined. Like Emacs[fn:15] in general, Evil[fn:41] is extensible in Emacs Lisp[fn:37].
...
EXWM (Emacs X Window Manager)[fn:16] is a full-featured tiling X window manager for GNU/Emacs[fn:15] built on-top of XELB. It features:
...
General[fn:42] provides a more convenient method for binding keys in Emacs[fn:15], providing a unified interface for key definitions. Its primary purpose is to build on /existing/ functionality to make key definitions more clear and concise.
...
Which-key[fn:43] is a minor mode for Emacs[fn:15] that displays the key bindings following your currently entered incomplete command (prefix) in a popup or mini-buffer.
...
The Emacs Web Wowser[fn:44] is a Web browser written in Emacs Lisp[fn:37] based on the ~shr.el~ library. It's my primary browser when it comes to text-based browsing.
...
ERC[fn:45] is a powerful, modular, and extensible IRC client for GNU/Emacs[fn:15]. It's part of the GNU project, and included in Emacs.
...
Dired[fn:46] shows a directory listing inside of an Emacs[fn:15] buffer that can be used to perform various file operations on files and subdirectories. THe operations you can perform are numerous, from creating subdirectories, byte-compiling files, searching, and editing files. Dired-Extra[fn:47] provides extra functionality for Dired[fn:46].
...
All The Icons[fn:48] is a utility package to collect various Icon Fonts and prioritize them within GNU/Emacs[fn:15].
...
Emojify[fn:49] is an Emacs[fn:15] extension to display Emojis. It can display GitHub style Emojis like :smile: or plain ascii ones such as :). It tries to be as efficient as possible, while also providing flexibility.
...
EShell [fn:50] is a shell-like command interpreter for GNU/Emacs[fn:15] implemented in Emacs Lisp[fn:37]. It invokes no external processes except for those requested by the user. It's intended to be an alternative for IELM, and a full REPL envionment for Emacs[fn:15].
...
Emacs Libvterm (VTerm)[fn:51] is a fully-fledged terminal emulator inside GNU/Emacs[fn:15] based on Libvterm[fn:52], a blazing fast C library used in Neovim[fn:38]. As a result of using compiled code (instead of Emacs Lisp[fn:37]), VTerm[fn:51] is capable, fast, and it can seamlessly handle large outputs.
...
Magit[fn:53] is an interface to the Git[fn:36] version control system, implemented as a GNU/Emacs[fn:15] package written in Elisp[fn:37]. It fills the glaring gap between the Git[fn:36] command line interface and various GUIs, letting you perform trivial as well as elaborate version control tasks within a few mnemonic key presses.
...
Elfeed[fn:54] is an extensible web feed reader for GNU/Emacs[fn:15], support both =Atom= and =RSS=. It requires =Emacs 24.3+= and is available for download from the standard repositories.
...
Org-mode[fn:55] is a document editing and organizing mode, designed for notes, planning, and authoring within the free software text editor GNU/Emacs[fn:15]. The name is used to encompass plain text files (such as this one) that include simple marks to indicate levels of a hierarchy, and an editor with functions that can read the markup and manipulate the hierarchy elements.
...
Org Roam[fn:56] is a plain-text knowledge management system. It borrows principles from the Zettelkasten method[fn:57], providing a solution for non-hierarchical note-taking. It should also work as a plug-and-play solution for anyone already using Org Mode[fn:55] for their personal wiki (me).
...
Org Drill[fn:58] is an extension for Org Mode[fn:55] that uses a spaced repition algorithm to conduct interactive /Drill Sessions/ using Org files as sources of facts to be memorized.
...
The way Org Mode[fn:55] works, TODO items, time-stamped items, and tagged headlines can be scattered throughout a file, or even a number of files. To get an overview of open action items, or of events that are important for a particular date, this information must be collected, sorted, and displayed in an organized way.
...
Writegood Mode[fn:61] is an Emacs[fn:15] minor mode to aid in finding common writing problems. It highlights the text based on the following criteria:
...
GNU Aspell[fn:62] is a Free and Open Source spell checker designed to replace ISpell. It can be used as a library, or an independent spell checker. Its main feature is that it does a superior job of suggesting possible replacements for mis-spelled words than any other spell checker for the English language.
...
It's possible to make HTTP requests from Org Mode buffers using ob-http[fn:65], this relies on Org Babel being present and configured properly.
...
Ox-Hugo[fn:66] is an Org-Mode[fn:55] exporter for Hugo[fn:26] compabile markdown. My dotfiles are a result of this, and are available to view here https://chrishayward.xyz/dotfiles/.
...
Manage Docker from inside of Emacs using Docker.el[fn:68]. This is a full docker porcelain similar to Magit, allowing complete control of a Docker system. Add syntax highlighting to Dockerfiles using dockerfile-mode[fn:69] from Spotify.
...
Projectile[fn:70] is a project interaction library for GNU/Emacs[fn:15]. Its goal is to provide a nice set of features operating on a project level, without introducing external dependencies.
...
The Language Server Protocol (LSP)[fn:71] defines the protocol used between an Editor or IDE, and a language server that provides features like:
...
Emacs CCLS[fn:72] is a client for CCLS, a C/C++/Objective-C language server supporting multi-million line C++ code bases, powered by libclang.
...
Company[fn:73] is a text completion framework for GNU/Emacs[fn:15]. The name stands for =Complete Anything=. It uses pluggable back-ends and front-ends to retieve and display completion candidates.
...
Go Mode[fn:74] is a major mode for editing Golang[fn:1] source code in GNU/Emacs[fn:15].
...
Rustic[fn:73] is a fork of rust-mode that integrates well with the Language Server Protocol[fn:67]. Include the rust shell before launching GNU/Emacs[fn:15] to use this!
...
The built in Python Mode[fn:75] has a nice feature set for working with Python[fn:8] code in GNU/Emacs[fn:15]. It is complimented with the addition of an LSP[fn:71] server. These tools are included in the Development Shell[fn:76] for Python[fn:8].
...
PlantUML Mode[fn:78] is a major mode for editing PlantUML[fn:77] sources in GNU/Emacs[fn:15].
...
Ivy (Swiper)[fn:79] is a generic completion mechanism for GNU/Emacs[fn:15]. While operating similarily to other completion schemes like =icomplete-mode=, it aims to be more efficient, smaller, simpler, and smoother to use, while remaining highly customizable.
...
It's possible to control the frame opacity in GNU/Emacs[fn:15]. Unlike other transparency hacks, it's not merely showing the desktop background image, but is true transparency -- you can se other windows behind the Emacs[fn:15] window.
...
The Desktop Environment[fn:80] package provides commands and a global minor mode for controlling your GNU/Linux[fn:23] desktop from within GNU/Emacs[fn:15].
...
Doom Themes[fn:81] is a theme megapack for GNU/Emacs[fn:15], inspired by community favourites.
...
Doom Modeline[fn:81] is a fancy and fast modeline inspired by minimalism design. It's integrated into Centaur Emacs, Doom Emacs, and Spacemacs.
...
[fn:2] https://rust-lang.org

[fn:3] https://nodejs.org

[fn:4] https://openjdk.java.net

[fn:5] https://grpc.io

[fn:6] https://iso.org/standard/74528.html

[fn:7] https://en.wikipedia.org/wiki/C++/

[fn:8] https://python.org

[fn:9] https://docs.docker.com/compose/

[fn:10] https://docker.org

[fn:11] https://docs.docker.com/machine/

[fn:12] https://heroku.com

[fn:13] https://nixos.org/manual/nixos/stable

[fn:14] https://qemu.org

[fn:15] https://gnu.org/software/emacs/

[fn:16] https://github.com/ch11ng/exwm

[fn:17] https://laptopmedia.com/laptop-specs/acer-nitro-5-an515-53-2

[fn:18] https://raspberrypi.org/products/raspberry-pi-400/

[fn:19] https://www.raspberrypi.org/products/raspberry-pi-4-model-b/

[fn:20] https://samsung.com/us/mobile/galaxy-s10/buy/

[fn:21] https://github.com/t184256/nix-on-droid

[fn:22] https://x.org/wiki/

[fn:23] https://gnu.org

[fn:24] https://wayland.freedesktop.org

[fn:25] https://openssh.com

[fn:26] https://gohugo.io

[fn:27] https://nixos.wiki/wiki/Flakes

[fn:28] https://nixos.org/manual/nix/stable

[fn:29] https://nix-community.cachix.org

[fn:30] https://nixos.wiki/wiki/Nvidia
...
[fn:35] https://github.com/nix-community/home-manager

[fn:36] https://git-scm.com

[fn:37] https://emacswiki.org/emacs/LearnEmacsLisp

[fn:38] https://neovim.io

[fn:39] https://gtk.org

[fn:40] https://github.com/nixos/nix-mode

[fn:41] https://evil.readthedocs.io/en/latest/overview.html

[fn:42] https://github.com/noctuid/general.el

[fn:43] https://github.com/justbur/emacs-which-key

[fn:44] https://emacswiki.org/emacs/eww

[fn:45] https://gnu.org/software/emacs/erc.html

[fn:46] https://emacswiki.org/emacs/DiredMode

[fn:47] https://emacswiki.org/emacs/DiredExtra#Dired_X

[fn:48] https://github.com/domtronn/all-the-icons.el

[fn:49] https://github.com/iqbalansari/emacs-emojify

[fn:50] https://gnu.org/software/emacs/manual/html_mono/eshell.html

[fn:51] https://github.com/akermu/emacs-libvterm

[fn:52] https://github.com/neovim/libvterm

[fn:53] https://magit.vc

[fn:54] https://github.com/skeeto/elfeed

[fn:55] https://orgmode.org

[fn:56] https://github.com/org-roam/org-roam

[fn:57] https://zettelkasten.de

[fn:58] https://orgmode.org/worg/org-contrib/org-drill.html

[fn:59] https://github.com/marcinkoziej/org-pomodoro

[fn:60] https://en.wikipedia.org/wiki/Pomodoro_Technique

[fn:61] https://github.com/bnbeckwith/writegood-mode

[fn:62] https://aspell.net

[fn:63] https://wikipedia.org/wiki/Tex_Live

[fn:64] https://nixos.wiki/wiki/TexLive

[fn:65] https://github.com/zweifisch/ob-http

[fn:66] https://oxhugo.scripter.co

[fn:67] https://password-store.org

[fn:68] https://github.com/Silex/docker.el

[fn:69] https://github.com/spotify/dockerfile-mode

[fn:70] https://projectile.mx

[fn:71] https://microsoft.github.io/language-server-protocol

[fn:72] https://github.com/MaskRay/emacs-ccls

[fn:73] https://company-mode.github.io

[fn:74] https://emacswiki.org/emacs/GoMode

[fn:75] https://plantuml.com

[fn:76] https://nixos.org/manual/nix/unstable/command-ref/nix-shell.html
...
[fn:82] https://literateprogramming.com/knuthweb.pdf

[fn:83] https://nixos.org/manual/nixpkgs/stable

[fn:84] https://github.com/nixos/nixos-hardware

[fn:85] https://github.com/nix-community/emacs-overlay
