...
This is my Samsung Galaxy S10+[fn:23] running Nix On Droid[fn:10] with the experimental support for Flakes being used to manage the configuration.
...
Company[fn:71] is a text completion framework for GNU/Emacs[fn:2]. The name stands for =Complete Anything=. It uses pluggable back-ends and front-ends to retieve and display completion candidates.
...
Go Mode[fn:72] is a major mode for editing Golang[fn:12] source code in GNU/Emacs[fn:2].
...
PlantUML[fn:74] is an open-source tool allowing users to create diagrams from a plain-text language. Besides various UML diagrams, PlantUML[fn:74] has support for various other software developmented related formats, as well as visualizations of =JSON= and =YAML= files.
...
PlantUML Mode[fn:75] is a major mode for editing PlantUML[fn:74] sources in GNU/Emacs[fn:2].
...
Ivy (Swiper)[fn:76] is a generic completion mechanism for GNU/Emacs[fn:2]. While operating similarily to other completion schemes like =icomplete-mode=, it aims to be more efficient, smaller, simpler, and smoother to use, while remaining highly customizable.
...
The Desktop Environment[fn:77] package provides commands and a global minor mode for controlling your GNU/Linux[fn:1] desktop from within GNU/Emacs[fn:2].
...
Doom Themes[fn:78] is a theme megapack for GNU/Emacs[fn:2], inspired by community favourites.
...
Doom Modeline[fn:79] is a fancy and fast modeline inspired by minimalism design. It's integrated into Centaur Emacs, Doom Emacs, and Spacemacs.
...
[fn:23] https://samsung.com/us/mobile/galaxy-s10/buy/
...
[fn:70] https://github.com/MaskRay/emacs-ccls

[fn:71] https://company-mode.github.io

[fn:72] https://emacswiki.org/emacs/GoMode

[fn:73] https://plantuml.com

[fn:74] https://github.com/skuro/plantuml-mode

[fn:75] https://github.com/abo-abo/swiper

[fn:76] https://github.com/DamienCassou/desktop-environment

[fn:77] https://github.com/hlissner/emacs-doom-themes

[fn:78] https://github.com/seagle0128/doom-modeline

[fn:79] https://laptopmedia.com/laptop-specs/acer-nitro-5-an515-53-2

[fn:80] https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html
